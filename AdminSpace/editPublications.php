<?php
   ...
   if(isset($_REQUEST["text"])){
      ...
      file_put_contents("../DB/publication.txt",$str);
      // informing the user
      ?>
         <script>alert("Publications Has Been Updated Successfuly!");</script>
      <?php
   }
   $text=file_get_contents("../DB/publication.txt");
?>
<!doctype html>
<html>
   <head>
   ...
   <body>
      ...
      <form method="post" action="editPublications.php">
