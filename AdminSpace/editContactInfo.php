<?php
   ...
   if(isset($_REQUEST["text"])){
      ...
      file_put_contents("../DB/contactInfo.txt",$str);
      // informing the user
      ?>
         <script>alert("Contact Info Has Been Updated Successfuly!");</script>
      <?php
   }
   $text=file_get_contents("../DB/contactInfo.txt");
?>
<!doctype html>
<html>
   <head>
   ...
   <body>
      ...
      <form method="post" action="editContactInfo.php">
